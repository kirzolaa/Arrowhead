#!/usr/bin/env python3
"""
Run a simulation with the optimal parameters that achieve 0 parity flips in eigenstate 3
and save all results to the parameter_analysis/optimal_zero_flip directory.
"""
...
BASE_DIR = "parameter_analysis/optimal_zero_flip"
...
X_SHIFT = 22.5
Y_SHIFT = 547.7222222222222  # This configuration has fewer parity flips in eigenstates 1 and 2
D_PARAM = 0.005
OMEGA = 0.025
A_VX = 0.018
A_VA = 0.42
...
def run_optimal_simulation():
    ...
    print(f"\n=== Running simulation with optimal parameters (0 parity flips in eigenstate 3) ===")
    ...
    with open(summary_file, "w") as f:
        f.write("Optimal Configuration Summary (0 Parity Flips in Eigenstate 3)\n")
        f.write("==========================================================\n\n")
