...
def visualize_perfect_orthogonal_circle(points):
    ...
    import os
    if not os.path.exists('perfect_circle_output'):
        os.makedirs('perfect_circle_output')
    ...
    # Save the figure
    plt.savefig('perfect_circle_output/perfect_circle_3d.png', dpi=300, bbox_inches='tight')
    ...
    plt.tight_layout()
    plt.savefig('perfect_circle_output/perfect_circle_projections.png', dpi=300, bbox_inches='tight')
    ...
    plt.legend()
    plt.axis('equal')
    plt.savefig('perfect_circle_output/perfect_circle_orthogonal_plane.png', dpi=300, bbox_inches='tight')
    
    print(f"Visualizations saved to 'perfect_circle_output' directory.")
...
def main():
    ...
    print(f"Generating perfect circle with {num_points} points...")
    print(f"Parameters: R_0=(0,0,0), d={d}")
    
    # Generate circle
    points = generate_perfect_orthogonal_circle(d, num_points)
    
    # Verify circle properties
    verification = verify_circle_properties(points)
    
    print("\nCircle Properties Verification:")
    ...
    with open('perfect_circle_output/verification_results.txt', 'w') as f:
    ...
    print("\nVerification results saved to 'perfect_circle_output/verification_results.txt'")
